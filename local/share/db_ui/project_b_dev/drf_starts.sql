...
select drf_starts.id as drf_start_id, races.id as race_id, races.date, races.track_code, races.distance, races.all_source_surface_code, races.race_number
from drf_races, races, drf_starts
where
starts.id in (
