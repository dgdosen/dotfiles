...
vim.keymap.set("n", "h1", function() harpoon:list():select(2) end, { desc = '[h]arpoon select [1]' })
vim.keymap.set("n", "h2", function() harpoon:list():select(3) end, { desc = '[h]arpoon select [2]' })
vim.keymap.set("n", "h3", function() harpoon:list():select(4) end, { desc = '[h]arpoon select [3]' })
vim.keymap.set("n", "h4", function() harpoon:list():select(5) end, { desc = '[h]arpoon select [4]' })
vim.keymap.set("n", "h5", function() harpoon:list():select(6) end, { desc = '[h]arpoon select [5]' })
vim.keymap.set("n", "h6", function() harpoon:list():select(7) end, { desc = '[h]arpoon select [6]' })
